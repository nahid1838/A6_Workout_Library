...
const Banner = () => {
    return (
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 bg-[#222630] pl-10 pt-12 pb-4 mt-8 rounded-2xl">
            <div className="flex flex-col gap-8">
                <p className="text-[#C2F800]">WORKOUT LIBRARY</p>
                <h1 className="text-4xl md:text-5xl font-bold scale-y-130 md:scale-y-150">TRAIN WITH INTENT. LOG <br />EVERY SET.</h1>
            ...
            <Image className="mx-auto pt-5 md:pt-0"
            src={banner}
            alt="Banner Image"
            width={334}
            height={334}
